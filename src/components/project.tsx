...
const HeaderComp = () => {
  ...
  return (
    <div className = "w-full h-auto text-[#F9F9FB] dark:text-[#121316] font-extrabold py-3 sm:py-4 border-b-[1.5px] border-b-[#BEC0D7] flex flex-col items-center">
      ...
      <div className = "relative w-[90%] max-w-[720px] h-[150px] sm:h-[200px] mt-5 mb-2 rounded-xl font-['Nanum_Gothic'] text-xl sm:text-3xl" onMouseEnter={() => setIsShown(true)} onMouseLeave={() => setIsShown(false)}>
      ...
      <div className = "relative w-[90%] max-w-[720px] h-[150px] sm:h-[200px] mt-5 mb-2 rounded-xl font-['Nanum_Gothic'] text-xl sm:text-3xl" onMouseEnter={() => setIsShown2(true)} onMouseLeave={() => setIsShown2(false)}>
        <div className = "absolute w-full h-full bg-[#121316] dark:bg-[#F9F9FB] opacity-75 hover:opacity-[.45] duration-150 rounded-xl"/>
      ...
      <div className = "relative w-[90%] max-w-[720px] h-[150px] sm:h-[200px] mt-5 mb-2 rounded-xl font-['Nanum_Gothic'] text-xl sm:text-3xl" onMouseEnter={() => setIsShown3(true)} onMouseLeave={() => setIsShown3(false)}>
        <div className = "absolute w-full h-full bg-[#121316] dark:bg-[#F9F9FB] opacity-75 hover:opacity-[.45] duration-150 rounded-xl"/>
