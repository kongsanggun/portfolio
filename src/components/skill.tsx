        ...
        <div className="w-full h-[374px] sm:h-[394px] bg-[#E1E3EC] text-[#121316] font-['Nanum_Gothic']">
          <div id='sa' className="w-full h-full hidden flex-col items-center">
            ...
            <div className='w-[90%] sm:w-4/5 h-auto text-sm sm:text-base my-2 sm:my-4 text-gray-500'>
              <p>대학 내에 웹 프로그래밍 강의를 접하게 되면서 알게 된 프로그래밍 언어들입니다.</p>
              <p>강의를 들으면서 알려주신 사이트를 통하여 어떻게 개발하는지 알게 되었습니다.</p>
              <p>방학 때 위의 언어들을 활용하여 웹을 구현하는 스터디를 진행하였습니다.</p>
              <p>그러나 React.js를 통하여 웹을 제작하게 되면서 순수 HTML만으로 웹을 제작하고 있지는 않고 있습니다.</p>
          ...
          <div id='sb' className="w-full h-full hidden flex-col items-center">
            ...
            <div className='w-[90%] sm:w-4/5 h-auto text-sm sm:text-base my-2 sm:my-4 text-gray-500'>
              <p>React.js는 졸업 프로젝트를 통하여 웹 개발을 진행하였을 때 처음 접해보았습니다.</p>
              <p>위의 웹 프레임 워크의 최대 장점은 기존 HTML로 진행하였을 때 index.html 파일을 직접 수정 및 열람할 필요 없이 개발한 내역을 바로 웹 페이지로 반영한다는 점 입니다.</p>
              <p>또한 useEffect, useState 등 React 내에서 지원해주는 기능 또한 큰 도움이 되기에 지금까지도 Front-End를 개발할 때 쓰이고 있는 언어입니다.</p>
            </div>
          </div>
          ...
          <div id='sc' className="w-full h-full hidden flex-col items-center">
            ...
            <div className='w-[90%] sm:w-4/5 h-auto text-sm sm:text-base my-2 sm:my-4 text-gray-500'>
              <p>토이 프로젝트 작업 중 데이터를 가져오는 기능을 구현하기 위해여 조사 도중 Node.js를 접하게 되었습니다.</p>
              <p>Node.js는 제가 현재 사용하고 있는 언어인 Javascript만으로도 Server 및 Back-End를 구축 할 수 있는 플랫폼이 매력적이었습니다.</p>
              <p>위의 Node.js와 Express를 이용하여 데이터를 요청하면 정보를 수집하여 웹페이지에 나타내는 기능을 만들었고 그 이후 로그인 기능 제작 및 직접 개발한 서버리스 예제 제작 등 많은 도움을 주었습니다.</p>
            </div>
          </div>
          ...
          <div id='sd' className="w-full h-full hidden flex-col items-center">
            ...
            <div className='w-[90%] sm:w-4/5 h-auto text-sm sm:text-base my-2 sm:my-4 text-gray-500'>
              <p>프로젝트를 진행 중 팀원이 위의 알려 준 것을 계기로 접한 오픈소스 프레임워크입니다.</p>
              <p>제가 생각하는 장점은 별도의 css 파일을 생성하여 만들 필요 없어 className만을 이용하여 해당 Element의 Style을 정할 수 있는 것이 매력적으로 느껴졌습니다.</p>
              <p>현재는 웹 개발 할 때 CSS 대신 주로 사용하고 있는 프레임워크입니다.</p>
            </div>
          </div>
          ...
          <div id='se' className="w-full h-full hidden flex-col items-center">
            ...
            <div className='w-[90%] sm:w-4/5 h-auto text-sm sm:text-base my-2 sm:my-4 text-gray-500'>
              <p>여러 프로젝트를 개발하게 되면서 다른 팀원들에게 작성한 코드를 보여주거나, 코드 수정을 원활하게 수정하기 위하여 자연스럽게 접하게 되었습니다.</p>
              <p>기능 테스트 등 목적에 따라 branch를 나뉘어 push 하거나 magre 하는 것이 특징입니다.</p>
              <p>현재는 제가 작성한 코드를 공유하거나 여러 기능을 개발하기 위하여 참고할 수 있는 용도 등으로 쓰이고 있습니다.</p>
            </div>
          </div>
          ...
          <div id='sf' className="w-full h-full hidden flex-col items-center">
            ...
            <div className='w-[90%] sm:w-4/5 h-auto text-sm sm:text-base my-2 sm:my-4 text-gray-500'>
              <p>여러 웹 사이트 배포 진행을 하기 위하여 여러 배포 구축 사이트를 조사하거나, 지인에게 물어보면서 고르게 되었습니다.</p>
              <p>다른 배포 구축 서비스와 달리 깃헙에서 관리를 하기 때문에 깃헙에서 리포를 푸시를 한다면 자동으로 배포를 진행하게 된다는 점에서 매력을 느껴 Firebase 등과 결합하여 홈페이지를 배포하고 있습니다.</p>
            </div>
          </div>
